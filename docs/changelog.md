...
All notable changes to _circumplex_ will be documented in this page and in the
repository `CHANGELOG.md`.

## Unreleased

!!! success "Massive update"
    This is the largest update to _circumplex_ so far and forms the basis of the
    upcoming 0.3 release. A major goal of this work has been to target feature parity
    and a familiar API for users of the fantastic R
    [circumplex](http://circumplex.jmgirard.com) package. The implementation is
    regression-tested against the R package to ensure equivalent results, and the
    Python package has been substantially reorganized, expanded, and hardened for
    public use.
